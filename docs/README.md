...
* **VR only works in multi-pass mode.** Even in multi-pass mode, you can't leverage certain features, like temporal reprojection and denoising for clouds and fog. Hopefully single-pass instanced support will come to Expanse one day.
